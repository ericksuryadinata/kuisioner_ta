    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li><a href="{{route('admin.assessment.tabel')}}">assessment</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form id="form_validation" novalidate="novalidate">
                        <div class="header">
                            <h2>UPLOAD HASIL ASSESSMENT</h2>
                        </div>
                        <div class="body">
                            <label for="email_address">File Hasil Assessment</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" class="form-control" name="file_assessment" id="myfile" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        $(function () {
            $('#btn').click(function () {
                ...
                formData.append('file_assessment', $('#myfile')[0].files[0]);
                formData.append([csrfName],csrfToken);
                $('#btn').attr('disabled', 'disabled');
                $('.msg').text('Uploading in progress...');
                $.ajax({
                    url: '<?php echo route("admin.assessment.tabel.upload.proses")?>',
                    data: formData,
                    processData: false,
                    contentType: false,
                    type: 'POST',
