            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form id="form_validation" novalidate="novalidate">
                        <div class="header">
                            <h2>UPLOAD PERTANYAAN KUISIONER</h2>
                        </div>
                        <div class="body">
                            <label for="email_address">File Pertanyaan Kuisioner</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" class="form-control" name="file_pertanyaan" id="myfile" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        $(function () {
            $('#btn').click(function () {
                ...
                formData.append('file_pertanyaan', $('#myfile')[0].files[0]);
                formData.append([csrfName],csrfToken);
                $('#btn').attr('disabled', 'disabled');
                $('.msg').text('Uploading in progress...');
                $.ajax({
                    url: '<?php echo route("admin.kuisioner.pertanyaan.upload.proses")?>',
                    data: formData,
                    processData: false,
                    contentType: false,
                    type: 'POST',
